...
This is phase 0 only: the D1 database is created with no schema/tables yet, and
the Worker script is a stub with no real logic. Its bindings are wired up now so
later phases can build directly on top without another apply.
